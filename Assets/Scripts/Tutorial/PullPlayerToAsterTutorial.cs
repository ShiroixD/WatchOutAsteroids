...
public class PullPlayerToAsterTutorial : Tutorial
{
    ...
    public override void CheckIfHappening()
    {
        ...
        if (_wasPulled && TutorialController.instance.player.GetComponent<PlayerController>()._isGrounded)
        {
            TutorialController.instance.expText.text = "Great! Press " + "f" + " or left mouse button to continue.";
            _wasDone = true;
        }
